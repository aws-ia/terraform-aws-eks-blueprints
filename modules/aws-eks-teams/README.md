...
| <a name="input_platform_team_iam_policy"></a> [platform\_team\_iam\_policy](#input\_platform\_team\_iam\_policy) | IAM policy for platform team IAM role | `string` | `""` | no |
...
| <a name="output_application_team_sa_irsa_name"></a> 
