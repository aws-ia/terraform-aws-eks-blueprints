...
|------|-------------|------|---------|:--------:|
| <a name="input_addon_config"></a> [addon\_config](#input\_addon\_config) | Amazon EKS Managed ADOT addon config | `any` | `{}` | no |
...
| <a name="input_helm_config"></a> [helm\_config](#input\_helm\_config) | Opentelemetry Operator Helm Chart config | `any` | `{}` | no |
