...
This add-on bootstraps a Trino cluster on the EKS cluster using a [helm chart](https://artifacthub.io/packages/helm/trino/trino) with the default configuration.
