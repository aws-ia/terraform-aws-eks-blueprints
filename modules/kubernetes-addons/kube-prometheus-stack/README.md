...
The default [values.yaml] file in this add-on has disabled the components that are unreachable in EKS environments. You can override the defaults using the `set_values` helm_config key:
