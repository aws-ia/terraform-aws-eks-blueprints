...
| <a name="module_aws_vpc_cni_metrics"></a> [aws\_vpc\_cni\_metrics](#module\_aws\_vpc\_cni\_metrics) | ./aws-vpc-cni-metrics | n/a |
...
| <a name="input_enable_aws_vpc_cni_metrics"></a> [enable\_aws\_vpc\_cni\_metrics](#input\_enable\_aws\_vpc\_cni\_metrics) | Enable AWS VPC CNI Metrics add-on | `bool` | `false` | no |
