...
| <a name="input_karpenter_sqs_queue_name"></a> [karpenter\_sqs\_queue\_name](#input\_karpenter\_sqs\_queue\_name) | (Optional) Name of SQS used by Karpenter when native node termination handling is enabled | `string` | `""` | no |
