...
| <a name="input_datadog_helm_config"></a> [datadog\_helm\_config](#input\_datadog\_helm\_config) | Datadog Agent Helm Chart config | `any` | `{}` | no |
...
| <a name="input_enable_datadog"></a> [enable\_datadog](#input\_enable\_datadog) | Enable Datadog Agent add-on | `bool` | `false` | no |
