...
| <a name="module_ray_operator"></a> [ray\_operator](#module\_ray\_operator) | ./ray-operator | n/a |
...
| <a name="input_enable_ray_operator"></a> [enable\_ray\_operator](#input\_enable\_ray\_operator) | Enable Ray Operator add-on | `bool` | `false` | no |
...
| <a name="input_ray_operator_helm_config"></a> [ray\_operator\_helm\_config](#input\_ray\_operator\_helm\_config) | Ray Operator Helm Chart config | `any` | `{}` | no |
