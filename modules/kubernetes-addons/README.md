...
| <a name="input_aws_node_termination_handler_enable_queue_processor"></a> [aws\_node\_termination\_handler\_enable\_queue\_processor](#input\_aws\_node\_termination\_handler\_enable\_queue\_processor) | Enable Queue Processor mode, default is IMDS Processor | `bool` | `true` | no |
