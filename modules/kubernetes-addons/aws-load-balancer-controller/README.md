...
| <a name="input_default_ecr_uri"></a> [default\_ecr\_uri](#input\_default\_ecr\_uri) | Amazon Container Image Registry URI. This is the default image repository and changes based on the region which the cluster resides. | `string` | n/a | yes |
