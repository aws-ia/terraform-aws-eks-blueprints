...
1. A PR against the main [EKS Blueprints](https://github.com/aws-samples/aws-eks-accelerator-for-terraform) repository that contains the following:
...
2. A second PR against the [EKS Blueprints Add-Ons](https://github.com/aws-samples/ssp-eks-add-ons) repository to create an ArgoCD application for your add-on. See example of other add-ons that shows what should be added. Add-ons that do not provide GitOps support are not expected to create this PR.
