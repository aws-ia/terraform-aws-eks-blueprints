...
module "aws-eks-accelerator-for-terraform" {
  ...
  managed_node_groups = {
    ...
    #---------------------------------------------------------#
    mg_4 = {
      node_group_name        = "managed-ondemand" # Name is used to create a dedicated IAM role for each node group and adds to AWS-AUTH config map
      ...
      max_size      = 10
      min_size      = 2
      capacity_type = "ON_DEMAND" # Optional Use this only for SPOT capacity as  capacity_type = "spot"
