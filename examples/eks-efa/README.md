...
- [Example Walkthrough](#example-walkthrough)
  ...
  - [6. Connect to EKS](#connect-to-eks)
  - [7. Deploy Kubeflow MPI Operator](#deploy-kubeflow-mpi-operator)
  - [8. Test EFA](#test-efa)
    - [8.1. EFA Info test](#efa-info-test)
    - [8.2. EFA NCCL test](#efa-nccl-test)
  - [9. Cleanup](#cleanup)
...
Columns 8 and 12 in the output show the in-place and out-of-place bus bandwidth calculated for the data size listed in column 1. In this case it is 3.13 and 3.12 GB/s respectively.
