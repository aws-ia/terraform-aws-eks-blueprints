...
local_computer_ip         = "<IP Address of the computer you are running and testing this example from>" # We configure a route table and security group that allows your computer to access an EC2 instance.                                                                       # set this to false if yor account already has the AWSServiceRoleForAmazonElasticsearchService role created
