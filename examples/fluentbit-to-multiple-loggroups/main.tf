...
resource "aws_cloudwatch_log_group" "application" {
  name              = "/eks/${module.eks_blueprints.eks_cluster_id}/application"
  retention_in_days = 7
...
resource "aws_cloudwatch_log_group" "dataplane" {
  name              = "/eks/${module.eks_blueprints.eks_cluster_id}/dataplane"
  retention_in_days = 7
  kms_key_id        = aws_kms_key.logs.arn
...
resource "aws_cloudwatch_log_group" "host" {
  name              = "/eks/${module.eks_blueprints.eks_cluster_id}/host"
  retention_in_days = 7
  kms_key_id        = aws_kms_key.logs.arn
...
module "eks_blueprints_kubernetes_addons" {
  ...
  aws_for_fluentbit_helm_config = {
    ...
    version                         = "0.1.16"
    namespace                       = "logging"
    aws_for_fluent_bit_cw_log_group = aws_cloudwatch_log_group.application.name
    create_namespace                = true
    values = [templatefile("${path.module}/helm_values/aws-for-fluentbit-values.yaml", {
      aws_region           = local.region
      log_group_name       = aws_cloudwatch_log_group.application.name
      service_account_name = "${module.eks_blueprints.eks_cluster_id}-aws-for-fluent-bit-irsa"
