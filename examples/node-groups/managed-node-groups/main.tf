...
module "eks_blueprints" {
  ...
  eks_managed_node_groups = {
    ...
    mng_lt = {
      ...
      name = "mng_lt" # Max 40 characters for node group name
      ...
      subnet_ids  = module.vpc.private_subnets # Define your private/public subnets list with comma separated subnet_ids  = ['subnet1','subnet2','subnet3']
    ...
    mng_custom_ami = {
      # Node Group configuration
      name = "mng_custom_ami" # Max 40 characters for node group name
