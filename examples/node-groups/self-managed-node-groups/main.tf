...
module "eks_blueprints" {
  ...
  self_managed_node_groups = {
    ...
    #---------------------------------------------------------#
    self_mg_4 = {
      node_group_name = "self_mg_4" # Name is used to create a dedicated IAM role for each node group and adds to AWS-AUTH config map
      ...
      iam_instance_profile_name = aws_iam_instance_profile.self_managed_ng.name #Passing custom IAM role
