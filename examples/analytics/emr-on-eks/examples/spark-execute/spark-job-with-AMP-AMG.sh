      ...
      "applicationConfiguration": [
          {
            ...
            "properties": {
              "spark.local.dir": "/local1/ny-taxi",
              "spark.kubernetes.driver.podTemplateFile":"'"$SPARK_JOB_S3_PATH"'/pod-templates/spark-driver-nytaxi.yaml",
              "spark.kubernetes.executor.podTemplateFile":"'"$SPARK_JOB_S3_PATH"'/pod-templates/spark-executor-nytaxi.yaml",
