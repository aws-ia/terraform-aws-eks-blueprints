...
output "platform_teams_configure_kubectl" {
  ...
  value       = module.eks-blueprints.teams[0].platform_teams_configure_kubectl
}
...
output "application_teams_configure_kubectl" {
  ...
  value       = module.eks-blueprints.teams[0].application_teams_configure_kubectl
}
