...
| <a name="input_cluster_kms_key_additional_admin_arns"></a> [cluster\_kms\_additional\_admin\_arns](#input\_cluster\_kms\_additional\_admin\_arns) | A list of additional IAM ARNs that should have FULL access (kms:*) in the KMS key policy. | `list(string)` | `[]` | no |
